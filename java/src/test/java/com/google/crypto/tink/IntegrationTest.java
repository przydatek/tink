...
public class IntegrationTest {
    ...
    HybridDecrypt hybridDecrypt =
        CleartextKeysetHandle.read(
                BinaryKeysetReader.withFile(
                    new File("../tink/testdata/ecies_private_keyset2.bin")))
            .getPrimitive(HybridDecrypt.class);

    HybridEncrypt hybridEncrypt =
        CleartextKeysetHandle.read(
                BinaryKeysetReader.withFile(
                    new File("../tink/testdata/ecies_public_keyset2.bin")))
  ...
  public void testWithTinkeyEciesAesCtrHmacAead() throws Exception {
    ...
    HybridDecrypt hybridDecrypt =
        CleartextKeysetHandle.read(
                BinaryKeysetReader.withFile(
                    new File("../tink/testdata/ecies_private_keyset.bin")))
            .getPrimitive(HybridDecrypt.class);

    HybridEncrypt hybridEncrypt =
        CleartextKeysetHandle.read(
                BinaryKeysetReader.withFile(
                    new File("../tink/testdata/ecies_public_keyset.bin")))
            .getPrimitive(HybridEncrypt.class);
